...
type AutomotiveCatalogIntroProps = {
  automotiveRoute: string;
  catalogHref?: string;
};

export function AutomotiveCatalogIntro({
  automotiveRoute,
  catalogHref = "/catalog",
}: AutomotiveCatalogIntroProps) {
      ...
      <section className="grid min-h-[520px] items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="flex flex-col items-start gap-6">
          ...
          <div className="max-w-3xl space-y-4">
            <h1 className="text-4xl font-black leading-tight text-white md:text-5xl xl:text-[52px]">
              {t("automotive.title")}
            </h1>
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            >
              <Link href={catalogHref}>{t("automotive.viewCatalog")}</Link>
            </Button>
          </div>
        </div>
  ...
  return (
    <PageShell backgroundStyle={catalogBackgroundStyle}>
      <main className="relative mx-auto flex w-full max-w-7xl flex-col gap-12 px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        ...
        <AutomotiveCatalogIntro automotiveRoute={automotiveRoute} />
...
export function AutomotiveServicesGrid({
  services,
  categoryNamesById,
}: {
  services: Service[];
